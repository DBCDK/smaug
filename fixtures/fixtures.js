...
nock('https://borchk.addi.dk:443', {encodedQueryParams: true})
  ...
  .reply(
    200,
    '<?xml version="1.0" encoding="UTF-8"?><SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/" xmlns="http://oss.dbc.dk/ns/borchk"><SOAP-ENV:Body><borrowerCheckResponse><userId>0102033690</userId><requestStatus>ok</requestStatus></borrowerCheckResponse></SOAP-ENV:Body></SOAP-ENV:Envelope>',
    [
      'Date',
      'Tue, 15 Oct 2019 13:34:05 GMT',
      'Server',
...
nock('https://borchk.addi.dk:443', {encodedQueryParams: true})
  ...
  .reply(
    200,
    '<?xml version="1.0" encoding="UTF-8"?><SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/" xmlns="http://oss.dbc.dk/ns/borchk"><SOAP-ENV:Body><borrowerCheckResponse><userId>0102033690</userId><requestStatus>borrower_not_found</requestStatus></borrowerCheckResponse></SOAP-ENV:Body></SOAP-ENV:Envelope>',
    [
      'Date',
      'Tue, 15 Oct 2019 13:34:06 GMT',
      'Server',
      'Apache/2.4.25 (Debian)',
      'Vary',
      'Accept-Encoding',
