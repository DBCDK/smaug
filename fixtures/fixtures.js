...
nock('https://borchk.addi.dk:443', {"encodedQueryParams":true})
  .persist()
  .post('/3.0/soap', "<soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"  xmlns:borchk=\"http://oss.dbc.dk/ns/borchk\" xmlns:borchkw=\"http://oss.dbc.dk/ns/borchk_wsdl\"><soap:Body><borchk:borrowerCheckRequest xmlns:borchk=\"http://oss.dbc.dk/ns/borchk\" xmlns=\"http://oss.dbc.dk/ns/borchk\"><borchk:userId>0102033690</borchk:userId><borchk:userPincode>0000</borchk:userPincode><borchk:libraryCode>DK-790900</borchk:libraryCode><borchk:serviceRequester>login.bib.dk</borchk:serviceRequester></borchk:borrowerCheckRequest></soap:Body></soap:Envelope>")
  .reply(200, "<?xml version='1.0' encoding='UTF-8'?><S:Envelope xmlns:S=\"http://schemas.xmlsoap.org/soap/envelope/\"><S:Body><borrowerCheckResponse xmlns=\"http://oss.dbc.dk/ns/borchk\"><userId>0102033690</userId><requestStatus>ok</requestStatus></borrowerCheckResponse></S:Body></S:Envelope>", [
    'server',
    'Payara Server  5.2021.4 #badassfish',
    'x-powered-by',
    'Servlet/4.0 JSP/2.3 (Payara Server  5.2021.4 #badassfish Java/GraalVM Community/11)',
...
nock('https://borchk.addi.dk:443', {"encodedQueryParams":true})
  .persist()
  .post('/3.0/soap', "<soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"  xmlns:borchk=\"http://oss.dbc.dk/ns/borchk\" xmlns:borchkw=\"http://oss.dbc.dk/ns/borchk_wsdl\"><soap:Body><borchk:borrowerCheckRequest xmlns:borchk=\"http://oss.dbc.dk/ns/borchk\" xmlns=\"http://oss.dbc.dk/ns/borchk\"><borchk:userId>0102033690</borchk:userId><borchk:userPincode>wrong</borchk:userPincode><borchk:libraryCode>DK-790900</borchk:libraryCode><borchk:serviceRequester>login.bib.dk</borchk:serviceRequester></borchk:borrowerCheckRequest></soap:Body></soap:Envelope>")
  .reply(200, "<?xml version='1.0' encoding='UTF-8'?><S:Envelope xmlns:S=\"http://schemas.xmlsoap.org/soap/envelope/\"><S:Body><borrowerCheckResponse xmlns=\"http://oss.dbc.dk/ns/borchk\"><userId>0102033690</userId><requestStatus>borrower_not_found</requestStatus></borrowerCheckResponse></S:Body></S:Envelope>", [
    'server',
    'Payara Server  5.2021.4 #badassfish',
    'x-powered-by',
    'Servlet/4.0 JSP/2.3 (Payara Server  5.2021.4 #badassfish Java/GraalVM Community/11)',
...
nock('https://borchk.addi.dk:443', {"encodedQueryParams":true})
  .persist()
  .post('/3.0/soap', "<soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"  xmlns:borchk=\"http://oss.dbc.dk/ns/borchk\" xmlns:borchkw=\"http://oss.dbc.dk/ns/borchk_wsdl\"><soap:Body><borchk:borrowerCheckRequest xmlns:borchk=\"http://oss.dbc.dk/ns/borchk\" xmlns=\"http://oss.dbc.dk/ns/borchk\"><borchk:userId>0</borchk:userId><borchk:userPincode>@790900</borchk:userPincode><borchk:libraryCode>DK-790900</borchk:libraryCode><borchk:serviceRequester>login.bib.dk</borchk:serviceRequester></borchk:borrowerCheckRequest></soap:Body></soap:Envelope>")
  .reply(200, "<?xml version='1.0' encoding='UTF-8'?><S:Envelope xmlns:S=\"http://schemas.xmlsoap.org/soap/envelope/\"><S:Body><borrowerCheckResponse xmlns=\"http://oss.dbc.dk/ns/borchk\"><userId>0</userId><requestStatus>borrower_not_found</requestStatus></borrowerCheckResponse></S:Body></S:Envelope>", [
    'server',
    'Payara Server  5.2021.4 #badassfish',
    'x-powered-by',
    'Servlet/4.0 JSP/2.3 (Payara Server  5.2021.4 #badassfish Java/GraalVM Community/11)',
